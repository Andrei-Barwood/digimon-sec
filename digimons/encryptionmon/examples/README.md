# 🎓 Ejemplos de Uso: Encryptionmon

¡Hola! Bienvenido al campo de entrenamiento de **Encryptionmon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"Forced Proximity"*, es clara: **Gestiona claves de cifrado**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Encryptionmon`. Es como sacar al Digimon de su Digivice.
