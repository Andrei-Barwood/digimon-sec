"""
Core functionality for CloudSecmon (Mega)

CloudSecmon audita configuraciones cloud con controles basicos.
...
class CloudSecmon:
    """
    CloudSecmon - Cloud Config Auditor (Mega)
