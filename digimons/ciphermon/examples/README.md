# 🎓 Ejemplos de Uso: Ciphermon

¡Hola! Bienvenido al campo de entrenamiento de **Ciphermon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"American Venom"*, es clara: **Cifra/descifra tráfico con algoritmos avanzados**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Ciphermon`. Es como sacar al Digimon de su Digivice.
