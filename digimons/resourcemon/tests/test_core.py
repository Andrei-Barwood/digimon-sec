"""
Unit tests for Resourcemon (Mega)
"""

import pytest

from resourcemon.core import Resourcemon
from resourcemon.models import AnalysisResult, AuditReport


@pytest.fixture
def digimon():
    """Fixture para crear instancia de Resourcemon"""
    return Resourcemon()
...
class TestAudit:
    ...
    "storage_usage": 50,
        ...
        report = digimon.audit_usage(sample)
...
class TestAnalyze:
    ...
    "storage_usage": 50,
        ...
        result = digimon.analyze(usage_data=sample)
