# 🎓 Ejemplos de Uso: RDSmon

Bienvenido al campo de entrenamiento de **RDSmon**.

Su mision, inspirada en *"The Noblest of Men"*, es clara: **Audita bases de datos cloud con controles basicos.**
...
1. **Invocacion**: Importa e instancia `RDSmon`.
