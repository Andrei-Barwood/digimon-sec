# Arquitectura - gdprmon

## Visión General

gdprmon es un módulo de ciberseguridad implementado como parte del **DIGIMON CYBERSECURITY SUITE**.
...
La clase `GDPRmon` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.
...
**Modelos Principales:**
- `DigimonConfig`: Configuration model for gdprmon
