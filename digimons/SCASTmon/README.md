...
En el universo de **DIGIMON CYBERSECURITY SUITE**, cada Digimon representa una especialidad de seguridad. SCASTmon encarna los principios de la misión "The Noblest of Men" de Red Dead Redemption 2, aplicados al dominio cibernético.
...
cd digimons/SCASTmon
pip install -e .

# O instalación directa
pip install SCASTmon
```

### Uso Básico

```python
from SCASTmon import Scastmon
...
El desarrollo de SCASTmon sigue la línea evolutiva de los Digimons:
