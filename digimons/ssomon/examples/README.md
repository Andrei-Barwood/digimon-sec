...
Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"Goodbye, Dear Friend"*, es clara: **Implementa Single Sign-On**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `SSOmon`. Es como sacar al Digimon de su Digivice.
