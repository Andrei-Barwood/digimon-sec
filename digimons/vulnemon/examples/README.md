# 🎓 Ejemplos de Uso: Vulnemon

¡Hola! Bienvenido al campo de entrenamiento de **Vulnemon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"Paradise Mercifully Departed"*, es clara: **Escanea vulnerabilidades conocidas**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Vulnemon`. Es como sacar al Digimon de su Digivice.
