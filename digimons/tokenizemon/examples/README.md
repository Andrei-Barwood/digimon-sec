# 🎓 Ejemplos de Uso: Tokenizemon

¡Hola! Bienvenido al campo de entrenamiento de **Tokenizemon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"Paradise Mercifully Departed"*, es clara: **Tokeniza datos sensibles**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Tokenizemon`. Es como sacar al Digimon de su Digivice.
