# 🎓 Ejemplos de Uso: Forensimon

¡Hola! Bienvenido al campo de entrenamiento de **Forensimon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"The New South"*, es clara: **Analiza logs y artifacts forenses**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Forensimon`. Es como sacar al Digimon de su Digivice.
