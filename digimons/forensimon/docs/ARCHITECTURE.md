...
La clase `Forensimon` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.
...
**Modelos Principales:**
- `DigimonConfig`: Configuration model for forensimon
