# 🎓 Ejemplos de Uso: Credentialmon

¡Hola! Bienvenido al campo de entrenamiento de **Credentialmon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"Good Intentions"*, es clara: **Almacena credenciales de forma segura**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Credentialmon`. Es como sacar al Digimon de su Digivice.
