# 🎓 Ejemplos de Uso: Identitymon

¡Hola! Bienvenido al campo de entrenamiento de **Identitymon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"The Gunslinger"*, es clara: **Gestiona identidades digitales**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Identitymon`. Es como sacar al Digimon de su Digivice.
