# 🎓 Ejemplos de Uso: Policymon

¡Hola! Bienvenido al campo de entrenamiento de **Policymon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"Charlotte Balfour"*, es clara: **Valida cumplimiento de políticas de seguridad**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Policymon`. Es como sacar al Digimon de su Digivice.
