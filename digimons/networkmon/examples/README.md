# 🎓 Ejemplos de Uso: Networkmon

¡Hola! Bienvenido al campo de entrenamiento de **Networkmon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"A Kind and benevolent Despot"*, es clara: **Monitorea tráfico de red en tiempo real**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Networkmon`. Es como sacar al Digimon de su Digivice.
