# Arquitectura - kubernetesmon

## Vision General

kubernetesmon es un modulo de ciberseguridad implementado como parte del **DIGIMON CYBERSECURITY SUITE**.
...
La clase `Kubernetesmon` es el punto de entrada principal.
