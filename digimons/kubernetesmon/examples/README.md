# 🎓 Ejemplos de Uso: Kubernetesmon

Bienvenido al campo de entrenamiento de **Kubernetesmon**.

Su mision, inspirada en *"Fleeting Joy"*, es clara: **Escanea clusters Kubernetes con controles de seguridad.**
...
1. **Invocacion**: Importa e instancia `Kubernetesmon`.
