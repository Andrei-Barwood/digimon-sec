# 🎓 Ejemplos de Uso: Hashmon

¡Hola! Bienvenido al campo de entrenamiento de **Hashmon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"Forever Yours, Arthur"*, es clara: **Verifica integridad con hashes**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Hashmon`. Es como sacar al Digimon de su Digivice.
