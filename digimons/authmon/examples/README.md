# 🎓 Ejemplos de Uso: Authmon

¡Hola! Bienvenido al campo de entrenamiento de **Authmon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"The Noblest of Men"*, es clara: **Implementa autenticación multifactor**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Authmon`. Es como sacar al Digimon de su Digivice.
