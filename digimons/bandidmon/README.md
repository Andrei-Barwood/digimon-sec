...
En el universo de **DIGIMON CYBERSECURITY SUITE**, cada Digimon representa una especialidad de seguridad. bandidmon encarna los principios de la misión "outlaws from the west" de Red Dead Redemption 2, aplicados al dominio cibernético.
...
cd digimons/bandidmon
pip install -e .

# O instalación directa
pip install bandidmon
```
...
El desarrollo de bandidmon sigue la línea evolutiva de los Digimons:
