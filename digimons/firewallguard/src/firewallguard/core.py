"""
Core functionality for FirewallGuard (Mega)

FirewallGuard gestiona y audita reglas de firewall.
...
class FirewallGuard:
    """
    FirewallGuard - Firewall Manager (Mega)
