...
Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"Red Dead Redemption"*, es clara: **Implementa autenticación multifactor**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `MFAmon`. Es como sacar al Digimon de su Digivice.
