# 🎓 Ejemplos de Uso: Thirstmon

¡Hola! Bienvenido al campo de entrenamiento de **Thirstmon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"Good, Honest Snake Oil"*, es clara: **Filtra IoCs maliciosos, distingue amenazas reales**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Thirstmon`. Es como sacar al Digimon de su Digivice.
