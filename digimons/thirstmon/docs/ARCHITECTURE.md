# Arquitectura - thirstmon

## Visión General

thirstmon es un módulo de ciberseguridad implementado como parte del **DIGIMON CYBERSECURITY SUITE**.
...
La clase `Thirstmon` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.
...
**Modelos Principales:**
- `DigimonConfig`: Configuration model for thirstmon
