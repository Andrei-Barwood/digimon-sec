# 🎓 Ejemplos de Uso: Terraformmon

Bienvenido al campo de entrenamiento de **Terraformmon**.

Su mision, inspirada en *"Red Dead Redemption"*, es clara: **Valida Infrastructure as Code con controles basicos.**
...
1. **Invocacion**: Importa e instancia `Terraformmon`.
