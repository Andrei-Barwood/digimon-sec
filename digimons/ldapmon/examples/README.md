...
Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"American Distillation"*, es clara: **Gestiona directorios LDAP**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `LDAPmon`. Es como sacar al Digimon de su Digivice.
