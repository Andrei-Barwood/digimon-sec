# 🎓 Ejemplos de Uso: Passwordmon

¡Hola! Bienvenido al campo de entrenamiento de **Passwordmon**.

Si estás aquí, es porque quieres ver a este Digimon en acción. Su misión, inspirada en *"The Gilded Cage"*, es clara: **Valida robustez de contraseñas**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `Passwordmon`. Es como sacar al Digimon de su Digivice.
