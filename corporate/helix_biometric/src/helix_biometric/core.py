"""
Core functionality for HelixBiometric (Production)

HelixBiometric procesa datos biométricos con verificación y liveness detection.
Misión: My Last Boy
...
class HelixBiometric:
    """
    HelixBiometric - Biometric Handler (Production)
