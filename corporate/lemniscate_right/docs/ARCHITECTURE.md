# Arquitectura - lemniscate_right

## Visión General

lemniscate_right es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: Charlotte Balfour
- **Rol de Seguridad**: gdpr-enforcer
...
La clase `LemniscateRight` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `audit_compliance()`: Audita cumplimiento GDPR de un objetivo
- `analyze()`: Ejecuta análisis: auditoría GDPR
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for lemniscate_right
- `GDPRCheck`: Individual GDPR compliance check result
- `GDPRComplianceReport`: GDPR compliance report
