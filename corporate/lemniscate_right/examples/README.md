# 🎓 Ejemplos de Uso: Gdprmon

¡Hola! Bienvenido al campo de entrenamiento de **Gdprmon**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Charlotte Balfour"*, es clara: **Cumple regulaciones GDPR**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `LemniscateRight`. Es como sacar al módulo de su sistema.
