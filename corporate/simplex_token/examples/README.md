# 🎓 Ejemplos de Uso: SimplexToken

¡Hola! Bienvenido al campo de entrenamiento de **SimplexToken**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Paradise Mercifully Departed"*, es clara: **Tokeniza datos sensibles**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `SimplexToken`. Es como sacar al módulo de su sistema.
