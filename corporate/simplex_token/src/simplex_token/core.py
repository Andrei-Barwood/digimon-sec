"""
Core functionality for SimplexToken (Production)

SimplexToken tokeniza datos sensibles con múltiples formatos y reversibilidad.
...
class SimplexToken:
    """
    SimplexToken - Tokenization Engine (Production)
