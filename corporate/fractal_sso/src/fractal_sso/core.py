"""
Core functionality for FractalSso (Production)

FractalSso implementa Single Sign-On con SAML y OpenID Connect.
...
class FractalSso:
    """
    FractalSso - SSO Manager (Production)
