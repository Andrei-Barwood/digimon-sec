# Arquitectura - fractal_sso

## Visión General

fractal_sso es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.
...
La clase `FractalSso` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for fractal_sso
