# 🎓 Ejemplos de Uso: Ssomon

¡Hola! Bienvenido al campo de entrenamiento de **Ssomon**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Goodbye, Dear Friend"*, es clara: **Implementa Single Sign-On**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `FractalSso`. Es como sacar al módulo de su sistema.
