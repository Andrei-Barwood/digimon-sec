# 🎓 Ejemplos de Uso: TorusToken

¡Hola! Bienvenido al campo de entrenamiento de **TorusToken**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Red Dead Redemption"*, es clara: **Genera y valida tokens seguros**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `TorusToken`. Es como sacar al módulo de su sistema.
