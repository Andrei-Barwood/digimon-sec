"""
Core functionality for FractalMask (Production)

FractalMask enmascara datos sensibles en logs preservando formato.
...
class FractalMask:
    """
    FractalMask - Data Masker (Production)
