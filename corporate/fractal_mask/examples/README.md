# 🎓 Ejemplos de Uso: FractalMask

¡Hola! Bienvenido al campo de entrenamiento de **FractalMask**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Good, Honest Snake Oil"*, es clara: **Enmascara datos sensibles en logs**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `FractalMask`. Es como sacar al módulo de su sistema.
