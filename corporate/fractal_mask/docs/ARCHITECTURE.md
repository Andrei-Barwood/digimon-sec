# Arquitectura - fractal_mask

## Visión General

fractal_mask es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.
...
La clase `FractalMask` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for fractal_mask
