...
def main():
    print("🚀 Iniciando misión: American Distillation")
    print("🛡️  Rol: Permission Checker")
    print("-" * 50)

    # 1. Inicialización
    # Aquí es donde 'invocamos' a nuestro módulo.
    # Puedes pasar configuración personalizada si lo necesitas.
    print(f"\n[1] Inicializando LatticePermission...")
    ...
    print(f"[3] Ejecutando análisis de seguridad (Valida permisos y accesos)...")
