# Arquitectura - lattice_permission

## Visión General

lattice_permission es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: American Distillation
- **Rol de Seguridad**: permission-checker
...
La clase `LatticePermission` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `check_permission()`: Verifica permisos de un recurso
- `analyze()`: Ejecuta análisis: un recurso o múltiples
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for lattice_permission
