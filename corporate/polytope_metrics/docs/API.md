# API Reference - polytope_metrics
...
```python
PolytopeMetrics(config: Optional[Dict[str, Any]] = None)
```
...
#### `track_security_kpis(metrics_data)`
...
Configuration model for polytope_metrics
