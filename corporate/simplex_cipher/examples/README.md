# 🎓 Ejemplos de Uso: SimplexCipher

¡Hola! Bienvenido al campo de entrenamiento de **SimplexCipher**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"American Venom"*, es clara: **Cifra/descifra tráfico con algoritmos avanzados**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `SimplexCipher`. Es como sacar al módulo de su sistema.
