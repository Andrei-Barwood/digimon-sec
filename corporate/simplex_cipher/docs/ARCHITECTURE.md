# Arquitectura - simplex_cipher

## Visión General

simplex_cipher es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.
...
La clase `SimplexCipher` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for simplex_cipher
