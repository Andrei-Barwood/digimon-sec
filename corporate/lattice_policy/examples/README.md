# 🎓 Ejemplos de Uso: LatticePolicy

¡Hola! Bienvenido al campo de entrenamiento de **LatticePolicy**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Charlotte Balfour"*, es clara: **Valida cumplimiento de políticas de seguridad**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `LatticePolicy`. Es como sacar al módulo de su sistema.
