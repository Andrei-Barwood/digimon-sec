# Arquitectura - lattice_policy

## Visión General

lattice_policy es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.
...
La clase `LatticePolicy` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for lattice_policy
