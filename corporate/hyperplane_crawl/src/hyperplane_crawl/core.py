"""
Core functionality for HyperplaneCrawl (Production)

HyperplaneCrawl previene web scraping con detección avanzada y bloqueo.
...
class HyperplaneCrawl:
    """
    HyperplaneCrawl - Anti-Scraping Tool (Production)
