# 🎓 Ejemplos de Uso: HyperplaneCrawl

¡Hola! Bienvenido al campo de entrenamiento de **HyperplaneCrawl**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"All Debts Are Paid"*, es clara: **Previene web scraping**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `HyperplaneCrawl`. Es como sacar al módulo de su sistema.
