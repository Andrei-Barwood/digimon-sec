# Arquitectura - geodesic_ledger

## Vision General

geodesic_ledger es un modulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.
...
La clase `GeodesicLedger` es el punto de entrada principal.
