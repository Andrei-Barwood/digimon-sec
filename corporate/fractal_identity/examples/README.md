# 🎓 Ejemplos de Uso: FractalIdentity

¡Hola! Bienvenido al campo de entrenamiento de **FractalIdentity**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"The Gunslinger"*, es clara: **Gestiona identidades digitales**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `FractalIdentity`. Es como sacar al módulo de su sistema.
