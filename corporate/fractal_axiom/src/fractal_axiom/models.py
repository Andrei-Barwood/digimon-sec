"""
Data models for fractal_axiom (Production).
...
class ModuleConfig(BaseModel):
    """Configuration model for fractal_axiom"""

    model_config = ConfigDict(frozen=True)

    name: str = Field(default="Fractal Axiom", description="Module name")
    ...
    require_encryption: bool = Field(default=True, description="Require encryption at rest")
    require_logging: bool = Field(default=True, description="Require logging enabled")
    require_mfa: bool = Field(default=True, description="Require MFA for admin access")
