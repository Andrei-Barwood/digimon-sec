...
```python
VertexHook(config: Optional[Dict[str, Any]] = None)
```
...
#### `manage_webhooks(webhook_data)`

Sin documentación.

#### `analyze(webhook_data)`
...
Configuration model for vertex_hook
