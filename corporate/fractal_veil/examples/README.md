# 🎓 Ejemplos de Uso: FractalVeil

¡Hola! Bienvenido al campo de entrenamiento de **FractalVeil**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Clemens Point"*, es clara: **Audita políticas de privacidad**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `FractalVeil`. Es como sacar al módulo de su sistema.
