...
def main():
    ...
    # 1. Inicialización
    print(f"\n[1] Inicializando GeodesicNetwork...")
    modulo = GeodesicNetwork(config={"alert_threshold": 5}) # Umbral bajo para forzar alertas en demo
    ...
    result = modulo.analyze(connections=traffic_batch)
