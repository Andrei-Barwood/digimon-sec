...
def main():
    print("🚀 Iniciando misión: Forced Proximity")
    print("🛡️  Rol: Encryption Manager")
    print("-" * 50)

    # 1. Inicialización
    # Aquí es donde 'invocamos' a nuestro módulo.
    # Puedes pasar configuración personalizada si lo necesitas.
    print(f"\n[1] Inicializando GeodesicCipher...")
    ...
    print(f"[3] Ejecutando análisis de seguridad (Gestiona claves de cifrado)...")
