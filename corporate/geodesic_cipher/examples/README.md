# 🎓 Ejemplos de Uso: GeodesicCipher

¡Hola! Bienvenido al campo de entrenamiento de **GeodesicCipher**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Forced Proximity"*, es clara: **Gestiona claves de cifrado**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `GeodesicCipher`. Es como sacar al módulo de su sistema.
