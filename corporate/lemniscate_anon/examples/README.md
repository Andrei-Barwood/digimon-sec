# 🎓 Ejemplos de Uso: LemniscateAnon

¡Hola! Bienvenido al campo de entrenamiento de **LemniscateAnon**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Charlotte Balfour"*, es clara: **Anonimiza datos de test**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `LemniscateAnon`. Es como sacar al módulo de su sistema.
