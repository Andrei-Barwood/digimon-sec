# 🎓 Ejemplos de Uso: SimplexPass

¡Hola! Bienvenido al campo de entrenamiento de **SimplexPass**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"The Gilded Cage"*, es clara: **Valida robustez de contraseñas**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `SimplexPass`. Es como sacar al módulo de su sistema.
