# 🎓 Ejemplos de Uso: LemniscateArchive

Bienvenido al campo de entrenamiento de **LemniscateArchive**.

Su mision, inspirada en *"My Last Boy"*, es clara: **Audita backups en cloud con controles basicos.**
...
1. **Invocacion**: Importa e instancia `LemniscateArchive`.
