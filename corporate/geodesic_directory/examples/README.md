# 🎓 Ejemplos de Uso: Ldapmon

¡Hola! Bienvenido al campo de entrenamiento de **Ldapmon**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"American Distillation"*, es clara: **Gestiona directorios LDAP**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `GeodesicDirectory`. Es como sacar al módulo de su sistema.
