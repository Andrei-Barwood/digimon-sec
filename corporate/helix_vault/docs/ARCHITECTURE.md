# Arquitectura - helix_vault

## Vision General

helix_vault es un modulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.
...
La clase `HelixVault` es el punto de entrada principal.
