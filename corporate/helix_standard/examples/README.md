...
Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"The Gunslinger"*, es clara: **Valida cumplimiento PCI-DSS**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `HelixStandard`. Es como sacar al módulo de su sistema.
