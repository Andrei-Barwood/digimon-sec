# Arquitectura - vertex_vuln

## Visión General

vertex_vuln es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.
...
La clase `VertexVuln` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for vertex_vuln
