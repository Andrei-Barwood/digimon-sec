"""
Core functionality for VertexVuln (Production)

VertexVuln escanea vulnerabilidades conocidas usando bases de datos CVE.
...
class VertexVuln:
    """
    VertexVuln - Vulnerability Scanner (Production)
