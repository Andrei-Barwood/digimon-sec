# 🎓 Ejemplos de Uso: VertexVuln

¡Hola! Bienvenido al campo de entrenamiento de **VertexVuln**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Paradise Mercifully Departed"*, es clara: **Escanea vulnerabilidades conocidas**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `VertexVuln`. Es como sacar al módulo de su sistema.
