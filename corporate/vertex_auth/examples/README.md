# 🎓 Ejemplos de Uso: VertexAuth

¡Hola! Bienvenido al campo de entrenamiento de **VertexAuth**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"The Noblest of Men"*, es clara: **Implementa autenticación multifactor**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `VertexAuth`. Es como sacar al módulo de su sistema.
