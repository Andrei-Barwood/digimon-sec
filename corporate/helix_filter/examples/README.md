# 🎓 Ejemplos de Uso: HelixFilter

¡Hola! Bienvenido al campo de entrenamiento de **HelixFilter**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Good, Honest Snake Oil"*, es clara: **Filtra IoCs maliciosos, distingue amenazas reales**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `HelixFilter`. Es como sacar al módulo de su sistema.
