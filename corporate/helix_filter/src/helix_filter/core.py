"""
Core functionality for HelixFilter (Production)

HelixFilter filtra indicadores de compromiso maliciosos con análisis avanzado.
...
class HelixFilter:
    """
    HelixFilter - Threat Filter (Production)
