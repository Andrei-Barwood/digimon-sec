# 🎓 Ejemplos de Uso: VertexHash

¡Hola! Bienvenido al campo de entrenamiento de **VertexHash**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Forever Yours, Arthur"*, es clara: **Verifica integridad con hashes**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `VertexHash`. Es como sacar al módulo de su sistema.
