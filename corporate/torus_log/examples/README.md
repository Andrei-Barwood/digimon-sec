# 🎓 Ejemplos de Uso: TorusLog

¡Hola! Bienvenido al campo de entrenamiento de **TorusLog**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Goodbye, Dear Friend"*, es clara: **Centraliza y analiza logs de seguridad**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `TorusLog`. Es como sacar al módulo de su sistema.
