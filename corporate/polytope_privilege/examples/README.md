# 🎓 Ejemplos de Uso: PolytopePrivilege

¡Hola! Bienvenido al campo de entrenamiento de **PolytopePrivilege**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Clemens Point"*, es clara: **Audita elevación de privilegios**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `PolytopePrivilege`. Es como sacar al módulo de su sistema.
