...
def main():
    print("🚀 Iniciando misión: Clemens Point")
    print("🛡️  Rol: Privilege Auditor")
    print("-" * 50)

    # 1. Inicialización
    # Aquí es donde 'invocamos' a nuestro módulo.
    # Puedes pasar configuración personalizada si lo necesitas.
    print(f"\n[1] Inicializando PolytopePrivilege...")
    modulo = PolytopePrivilege()
    ...
    print(f"[3] Ejecutando análisis de seguridad (Audita elevación de privilegios)...")
