"""
Data models for polytope_privilege (Production).
...
class ModuleConfig(BaseModel):
    """Configuration model for polytope_privilege"""

    model_config = ConfigDict(frozen=True)

    name: str = Field(default="Polytope Privilege", description="Module name")
