"""
Data models for tesseract_covenant (Production).
...
class ModuleConfig(BaseModel):
    """Configuration model for tesseract_covenant"""

    model_config = ConfigDict(frozen=True)

    name: str = Field(default="Tesseract Covenant", description="Module name")
