# Arquitectura - tesseract_beacon

## Visión General

tesseract_beacon es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: Polite Society
- **Rol de Seguridad**: threatintel-aggregator
...
La clase `TesseractBeacon` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `aggregate_threat_intel()`: Sin documentación
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for tesseract_beacon
