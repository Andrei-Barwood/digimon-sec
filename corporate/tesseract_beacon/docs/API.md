# API Reference - tesseract_beacon
...
```python
TesseractBeacon(config: Optional[Dict[str, Any]] = None)
```
...
#### `aggregate_threat_intel(intel_data)`
...
Configuration model for tesseract_beacon
