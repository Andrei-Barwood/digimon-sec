"""
Data models for torus_vault (Production).
...
class ModuleConfig(BaseModel):
    """Configuration model for torus_vault"""

    model_config = ConfigDict(frozen=True)

    name: str = Field(default="Torus Vault", description="Module name")
    strict_mode: bool = Field(default=True, description="Fail on missing critical settings")
    require_encryption: bool = Field(default=True, description="Require bucket encryption")
    require_versioning: bool = Field(default=True, description="Require bucket versioning")
    require_logging: bool = Field(default=True, description="Require access logging")
