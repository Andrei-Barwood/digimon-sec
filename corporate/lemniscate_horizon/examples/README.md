# 🎓 Ejemplos de Uso: LemniscateHorizon

Bienvenido al campo de entrenamiento de **LemniscateHorizon**.

Su mision, inspirada en *"Good Intentions"*, es clara: **Audita cumplimiento en cloud con controles basicos.**
...
1. **Invocacion**: Importa e instancia `LemniscateHorizon`.
