# 🎓 Ejemplos de Uso: Oauthmon

¡Hola! Bienvenido al campo de entrenamiento de **Oauthmon**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Marko Dragic"*, es clara: **Maneja flujos OAuth 2.0**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `LemniscateOauth`. Es como sacar al módulo de su sistema.
