# 🎓 Ejemplos de Uso: HelixTrace

¡Hola! Bienvenido al campo de entrenamiento de **HelixTrace**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"The New South"*, es clara: **Analiza logs y artifacts forenses**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `HelixTrace`. Es como sacar al módulo de su sistema.
