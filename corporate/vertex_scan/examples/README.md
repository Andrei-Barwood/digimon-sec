# 🎓 Ejemplos de Uso: VertexScan

¡Hola! Bienvenido al campo de entrenamiento de **VertexScan**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Protección del Digimundo"*, es clara: **Realiza operaciones de seguridad avanzadas**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `VertexScan`. Es como sacar al módulo de su sistema.
