# Arquitectura - Vertex Scan

## Visión General

Vertex Scan es un módulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.

- **Misión**: The Noblest of Men
- **Rol de Seguridad**: SAST Scanner
...
La clase `VertexScan` es el punto de entrada principal. Implementa la lógica de negocio y orquesta las operaciones de seguridad.

**Responsabilidades:**
- `analyze()`: Ejecutar análisis principal
...
**Modelos Principales:**
- `ModuleConfig`: Configuration model for Vertex Scan
