# 🎓 Ejemplos de Uso: TorusRedact

¡Hola! Bienvenido al campo de entrenamiento de **TorusRedact**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Outlaws from the West"*, es clara: **Redacta información PII automáticamente**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `TorusRedact`. Es como sacar al módulo de su sistema.
