# 🎓 Ejemplos de Uso: VertexCredential

¡Hola! Bienvenido al campo de entrenamiento de **VertexCredential**.

Si estás aquí, es porque quieres ver a este módulo en acción. Su misión, inspirada en *"Good Intentions"*, es clara: **Almacena credenciales de forma segura**.
...
1.  **Invocación**: Importamos e instanciamos la clase principal `VertexCredential`. Es como sacar al módulo de su sistema.
