"""
Core functionality for TesseractFactor (Production)

TesseractFactor implementa autenticación multifactor con múltiples métodos.
...
class TesseractFactor:
    """
    TesseractFactor - MFA Enforcer (Production)
