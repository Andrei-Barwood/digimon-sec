# 🎓 Ejemplos de Uso: SimplexContainer

Bienvenido al campo de entrenamiento de **SimplexContainer**.

Su mision, inspirada en *"A Kind and benevolent Despot"*, es clara: **Audita contenedores Docker con controles basicos.**
...
1. **Invocacion**: Importa e instancia `SimplexContainer`.
