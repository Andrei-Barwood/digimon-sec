# Arquitectura - simplex_container

## Vision General

simplex_container es un modulo de ciberseguridad implementado como parte del **Snocomm Security Suite**.
...
La clase `SimplexContainer` es el punto de entrada principal.
