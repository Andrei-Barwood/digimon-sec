"""
Core functionality for SimplexContainer (Production)

SimplexContainer audita configuraciones de contenedores Docker.
...
class SimplexContainer:
    """
    SimplexContainer - Docker Auditor (Production)
